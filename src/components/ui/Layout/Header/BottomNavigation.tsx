...
const BottomNavigationAction = styled(MuiBottomNavigationAction, {
    ...
    background: isCentered ? isSelected ? colors.background.gradient : colors.background.drawer : 'inherit',
       ...
       position: 'fixed',
        ...
        >
            {options?.map((bottomNav) => {
                ...
                return <BottomNavigationAction isCentered={!!isCentered} isSelected={pathname === href} key={label} label={label} icon={<Icon />} onClick={onClick} {...extraProps} />
            })}
        </MuiBottomNavigation>
    </Paper>
  )
