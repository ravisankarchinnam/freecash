...
import {AppBar as MuiAppBar, AppBarProps as MuiAppBarProps, Drawer, IconButton, styled, Toolbar, Box } from '@mui/material';
...
const Header = ({open, toggleDrawerOpen, chatDrawerWidth, children}: HeaderProps) => {
  return (
    <>
      <AppBar
        open={open}
