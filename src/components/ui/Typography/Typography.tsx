    ...
    shouldForwardProp: (prop) => prop !== "isGradient"
     && prop !== "backgroundSecondary"
      && prop !== "isBold"
       ...
       && prop !== "hasRadius"
       && prop !== "alignCenter"
  })<TypographyProps>(({ theme, isGradient, backgroundSecondary, isBold, isInlineBlock, hasRadius, alignCenter }) => ({
    ...(isGradient ? {background: colors.text.gradient} : undefined),
    ...(isGradient ? {color: 'transparent'} : undefined),
    ...(backgroundSecondary ? {background: colors.background.secondary} : undefined),
